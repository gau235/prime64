 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=Dih_R" >Dih_R.java</a>
 *
 * @see Dih
 */
public abstract class Dih_R extends Dih_L {
	...
	public static void colRecur(int n, int k, int min, int max, long prefix, KAryV32 kAryV32) {
		...
		if (k == 1) {
			...
			kAryV32.k[kAryV32.v++] = ((prefix << B64W6.$6) | n); // O.l( B64W6.toStrForToDiI(prefix, min) , THIS);
