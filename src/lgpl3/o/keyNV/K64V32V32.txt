 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=K64V32V32" >K64V32V32.java</a>
 *
 * @see K64V32
 *
 * @see K64V32V32
...
public class K64V32V32 implements Comparable<K64V32V32>, Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof K64V32V32)
			...
			return int64 == ((K64V32V32) obj).int64;
	...
	public StringBuilder toStr() {
		...
		return new StringBuilder(O.DEF_CAPACITY32_FOR_STR).append(O.C40).append(int64).append(O.C94).append(int32A).append(O.C94)
				.append(int32B).append(O.C41);
	}
}
