 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=Xyz32" >Xyz32.java</a>
 *
 */
public class Xyz32 implements Comparable<Xyz32>, Serializable {
	...
	public StringBuilder toStr() {
		...
		return new StringBuilder(O.DEF_CAPACITY32_FOR_STR).append(O.C40).append(x).append(O.C94).append(y).append(O.C94).append(z)
				.append(O.C41);
	}
}
