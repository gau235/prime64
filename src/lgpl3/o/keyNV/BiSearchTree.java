 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=BiSearchTree" >BiSearchTree.java</a>
 *
...
public class BiSearchTree implements Serializable {
	...
	public void toStrInorder(NodInBiSearchTree root) {
		...
		tmpStr.append(root.val).append(O.C_A_L); // O.l(root.val);
