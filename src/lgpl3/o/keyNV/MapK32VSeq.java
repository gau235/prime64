 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=MapK32VSeq" >MapK32VSeq.java</a>
 *
 * @see K64V
 */
public class MapK32VSeq extends Arr<K32VSeq> {
	...
	public void a(int int32, Seq seq) {
		...
		arr[iLen++] = new K32VSeq(int32, seq);
	...
	public Seq get(int int32) {
		...
		final int iFound = Arrays.binarySearch(arr, 0, iLen, new K32VSeq(int32, null));

		return ((iFound < 0) ? null : arr[iFound].seq);
