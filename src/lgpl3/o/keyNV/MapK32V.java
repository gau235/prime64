 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=MapK32V" >MapK32V.java</a>
 *
 * @see K32V
 */
public class MapK32V<V> extends Arr<K32V<V>> {
	...
	public V get(int int32) {
		...
		final int iFound = Arrays.binarySearch(arr, 0, iLen, new K32V<V>(int32, null));
