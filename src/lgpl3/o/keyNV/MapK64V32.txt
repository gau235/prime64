 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=MapK64V32" >MapK64V32.java</a>
 *
 * @see MapK64V32
 *
 * @see MapKSV32
...
public class MapK64V32 extends Arr<K64V32> implements Serializable {
	...
	public void easyPutNCount(long b64) {
		...
		if (iLen == 0) {
			...
			K64V32 tailK64V32 = arr[iLen - 1];

			if (tmpK64V32.int64 == tailK64V32.int64)
	...
	public StringBuilder toStr(CharSequence prefix, CharSequence lineWr) {
		...
		for (int idx = 0; idx != iLen;) {
			...
			tmpK64V32 = arr[idx];
			str.append(idx + 1).append(prefix).append(tmpK64V32.int64).append(O.C94).append(tmpK64V32.int32);
