 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=MapK32VAry32_2D" >MapK32VAry32_2D.java</a>
 *
 */
public class MapK32VAry32_2D extends Arr<K32VAry32_2D> {
	...
	public void a(int int32, Ary32_2D ary32_2D) {
		...
		arr[i++] = new K32VAry32_2D(int32, ary32_2D);
	...
	public Ary32_2D get(int int32) {
		...
		final int iFound = Arrays.binarySearch(arr, 0, i, new K32VAry32_2D(int32, null));
