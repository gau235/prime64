...
/**
 * @version 2022/05/14_00:00:00<br/>
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=O_A" >O_A.java</a>
 *
 * @see O_M
 */
public abstract class O_A extends Origin {

	// 當回傳值由簡入繁, 人類會抗拒, 如排列組合
	...
	//
	// 上帝對軟體限制:
	// 數學 (軟體) 不可故事接龍 (一人寫一段接起來 除非數學架構很完整) (參加社團)
	// 需要背舊包袱
	//
	// 數學沒辦法廣播討論
	...
	public static int rnd100() {
		...
		return ThreadLocalRandom.current().nextInt(800) >>> 3;
	}
