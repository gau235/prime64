 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=O_V" >O_V.java</a>
 *
 * @see O_W
 */
public abstract class O_V extends O_M {
	...
	public static long[] delTailAll0(long[] ary) {
		...
		int idxNot0 = ary.length - 1;
		for (; idxNot0 != -1; idxNot0--)
