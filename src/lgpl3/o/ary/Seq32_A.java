...
public abstract class Seq32_A implements Serializable {
	...
	public Seq32_A trim() {
		...
		if (i != fixedLen)
			...
			System.arraycopy(ary32, 0, (ary32 = new int[fixedLen = i]), 0, i);
	...
	public int head() {
		...
		return ((i == 0) ? Integer.MIN_VALUE : ary32[0]);
	}
	...
	public int tail() {
		...
		return ((i == 0) ? Integer.MIN_VALUE : ary32[i - 1]);
	}
	...
	public int cutHead() {
		...
		System.arraycopy(ary32, 1, ary32, 0, --i);
	...
	public int cutTail() { // O.xy(iLen, fixedLen); // O.l("ary32=" + ary32.length, THIS);
		...
		return ((i == 0) ? Integer.MIN_VALUE : ary32[--i]);
	}
	...
	public int cutAt(int idx) {
		...
		if (--i > idx)
			...
			System.arraycopy(ary32, idx + 1, ary32, idx, i - idx);
