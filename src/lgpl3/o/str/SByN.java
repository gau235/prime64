 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=SByN" >SByN.java</a>
 *
 * @see O
 */
public abstract class SByN extends O_A {
	 ...
	 */
	public static StringBuilder toPadded0Str(String prefix, long positiveOr0Num, int numOfDigit, String postfix) {

		return new StringBuilder(prefix).append(String.format("%0" + numOfDigit + "d", positiveOr0Num)).append(postfix);
	}
	 ...
	 */
	public static StringBuilder genPadded0Str(String prefix, int numOfDigit, String postfix) {

		return toPadded0Str(prefix, ThreadLocalRandom.current().nextLong(pow(10, numOfDigit)), numOfDigit, postfix);
	}
}
