 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=Miner" >src</a>
 *
 * @see PrimeAry2D
 *
 * @see Etchva
...
public abstract class Miner extends Miner_Y {
	...
	public static void checkArgBefMine(long n1, long n2, int numOfThr) {
		...
		Ranger.checkBetween(n2, n1, Miner.maxTestNByMyAryOfP);
