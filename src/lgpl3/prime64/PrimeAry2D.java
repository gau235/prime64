 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=PrimeAry2D" >PrimeAry2D.java</a>
 *
...
public class PrimeAry2D extends Arr<long[]> {
	...
	public int totalP() {
		...
		for (int idx = 0; idx != i; idx++) // when this is expanding, it does no harm
	...
	public static void checkIfAllAryConjoined(PrimeAry2D sortedPrimeAry2D) {
		...
		long to;
		for (int len = sortedPrimeAry2D.i; idx != len; idx++) {
