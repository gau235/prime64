 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=PeerByThrToMine" >PeerByThrToMine.java</a>
 *
 * @see ThrToMine
 */
	...
	public void run() {
		...
		do {
			...
			if (pAry2D.iLen != 0) {
				...
				str.append("len=" + O.f(pAry2D.iLen)).append(O.C_A_L);
