 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=Ex16_MineLargePrime" >Ex16_MineLargePrime.java</a>
 *
 */
public abstract class Ex16_MineLargePrime {
	...
	public static void main(String[] sAry) {
		...
		if (Miner.maxPInMyAryOfP < Miner.$MAX_TAIL_N_FOR_GROW_MY_ARY_OF_P) {

			t0 = O.t();

			Miner.setMyAryOfP(new Marker(1, Miner.$MAX_TAIL_N_FOR_GROW_MY_ARY_OF_P, B.I).

					retrieveP(1, Miner.$MAX_TAIL_N_FOR_GROW_MY_ARY_OF_P), Ex16_MineLargePrime.class);
