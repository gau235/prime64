 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=Ex13_CheckIfAllAryConjoined" >
...
public abstract class Ex13_CheckIfAllAryConjoined {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		O.l("primeAry2D.len=" + moonMP.primeAry2D.i);

		PrimeAry2D.checkIfAllAryConjoined(moonMP.primeAry2D);

		Miner.setMyAryOfP(moonMP.primeAry2D.mergeIn1Ary(), Ex13_CheckIfAllAryConjoined.class);
