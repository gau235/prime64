 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=Ex32_MineWThr" >Ex32_MineWThr.java</a>
 *
 */
public class Ex32_MineWThr {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		final int numOfThr = O.RUNTIME.availableProcessors() * 8 / 10;
