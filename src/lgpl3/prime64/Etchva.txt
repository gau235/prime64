 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=Etchva" >Etchva.java</a>
 *
 * @see Marker
 */
public abstract class Etchva {
	...
	/**
	 * 初始化時會找 1 ~ $INIT_TAIL_N32_FOR_ORI_ARY32_OF_P 的質數.<br/>
	 * The tail prime of origin array of prime.
	 */
	public static final int $INIT_TAIL_N32_FOR_ORI_ARY32_OF_P = 370_759;
	 ...
	 */
	public static int[] oriAry32OfP = Ary32va.toAry32(Miner.mineNRetAry(1L, $INIT_TAIL_N32_FOR_ORI_ARY32_OF_P));
