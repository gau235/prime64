 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=Hxy_A" >Hxy_A.java</a>
 *
 * @see Hxy_T
 */
public abstract class Hxy_A extends ShareWXyz {
	...
	public static void colRecur(int n, int k, int min, int max, long prefix, KAryV32 kAryV32) {
		...
		if (k == 1) {
			...
			kAryV32.k[kAryV32.v++] = ((prefix << B64W6.$6) | n); // O.l(Hxy.toStrByVCellPlusMinMinus1(prefix, min));
