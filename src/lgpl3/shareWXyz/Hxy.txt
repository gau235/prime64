 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=Hxy" >Hxy.java</a>
 *
 * @see Dih
 *
 * @see HxyVal
		...
		do {
			...
			if (((int) (b64W6 >>>= B64W6.$6)) == 0b0) { // terminate
				...
				if (vCell == 0)
					...
					retStr.append(Arrays.copyOfRange(CHAR_ARY_OF_$, 0, vCell));
			...
			if (vCell == 0)
				...
				retStr.append(Arrays.copyOfRange(CHAR_ARY_OF_$, 0, vCell)).append(O.C44);
