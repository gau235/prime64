 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=Ex80_Sort" >Ex80_Sort.java</a>
 *
 */
public class Ex80_Sort {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		int min = ((int) b64W6) & B64W6.MASK32;
		int max = B64W6.tailV(b64W6);
