 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=B64W6_C" >B64W6_C.java</a>
 *
 * @see B64W6_D
 */
public abstract class B64W6_C extends B64W6_A {
	...
	public static int getMin(long b64W6) {
		...
		int min = $MAX_INT32_IN_CELL, v;
		do
			if ((v = (((int) b64W6) & MASK32)) < min)

				min = v; // O.l("val=" + val + O.S9 + THIS);
	...
	public static int getMax(long b64W6) {
		...
		int max = 0, v;
		do
			if ((v = (((int) b64W6) & MASK32)) > max)

				max = v; // O.l("val=" + val + O.S9 + THIS);
