 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=P93_PCircAsDnk" >P93_PCircAsDnk.java</a>
 *
 */
public class P93_PCircAsDnk {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		O.eq(thr.box.i, DCirc.int64(n, k));
		...
		O.l("len=" + O.f(thr.box.i) + O.S9 + "diff=" + (PCirc.int64(n) - thr.count32));
