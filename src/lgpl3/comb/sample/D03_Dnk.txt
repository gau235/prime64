 ...
 *
 * @version 2022/03/23_12:30:00<br/>
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=D03_Dnk" >D03_Dnk.java</a>
 */
public class D03_Dnk {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		Arrays.sort(Aryva.checkDup(ary));

		StringBuilder str;

		str = Dnk.toHtmlWHead(ary, O.S_ARY_A_Z, O.S_ARY_A_Z, "tabForPInEx");
