 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=P84_InEx" >P84_InEx.java</a>
 */
public class P84_InEx {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		str = Dnk.toHtmlWHead(ary, O.S_ARY_A_Z, O.S_ARY_A_Z, "tabToPInEx");
