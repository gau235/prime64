 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=DCirc" >DCirc.java</a>
 *
 * @see Dnk
 */
	...
	public static void test() {
		...
		for (int n = 2; n <= endN; n++) {
			...
			for (int k = 2; k <= n; k++) {
				...
				O.eq(thrToPCircAsDnk.box.iLen, int64(n, k));
				...
				O.eq(thrToDCirc.box.iLen, int64(n, k));
