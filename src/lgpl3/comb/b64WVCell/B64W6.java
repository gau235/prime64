 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=B64W6" >B64W6.java</a>
 *
 * @see B32va
 */
public abstract class B64W6 extends B64W6_L {
	...
	public static long genB64W6WAll1(int len) {
		...
		while (--len != 0)
			...
			retB64W6 = (retB64W6 << $6) | 0b1;

		// O.l("retB64W6=" + O.L + str24(retB64W6), THIS);
