 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=OntoWArrOfSAryWEmpty" >OntoWArrOfSAryWEmpty.java</a>
 *
 * @see PowerSet
 */
public class OntoWArrOfSAryWEmpty {
	...
	public static void main(String[] sAry) {
		...
		for (int idx = 0; idx != retArr.iLen; idx++)
