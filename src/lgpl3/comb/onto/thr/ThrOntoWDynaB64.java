 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=ThrOntoWDynaB64" >ThrOntoWDynaB64.java</a>
 *
 */
public class ThrOntoWDynaB64 extends ThrS2WDynaB64_A {
	...
	public void pHori(int keptB32, int rmdK, long prefix) {
		...
		if ((rmdB32 & 0b1) == 0b0 && (keptB32 & 0b1) == 0b0) // 基礎橫列必含有 A // 原創
