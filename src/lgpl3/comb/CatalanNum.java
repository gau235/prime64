 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=CatalanNum" >CatalanNum.java</a>
 *
 * @see SelfCallva
 */
public abstract class CatalanNum {
	 ...
	 * C(2n,n)-C(2n,n-1)
	 */
	public static void winLose(final int totalW, long prefix, int countW, int countL, KAryV32 kV) { // first time must be 0b1L
	 ...
	 * C(2n,n)-C(2n,n-1)
	 */
	public static void push(long base, long stack, long ret, KAryV32 kV) {
	 ...
	 * C(2n,n)-C(2n,n-1)
	 */
	public static void pop(long base, long stack, long ret, KAryV32 kV) {
	 ...
	 * C(2n,n)-C(2n,n-1)
	 */
	public static void pushPop(long base, long stack, long ret, KAryV32 kV) {
	...
	public static StringBuilder strMatrixChainMul(long b64W6) { // 原創
		...
		ret.append((char) (++count)); // first is A

		do {
			ret.append(((((int) b64W6) & B64W6.MASK32) == ID_AS_WIN) ? ((char) ++count) : O.C42);
	...
	public static void main1(String[] sAry) throws Throwable {
		...
		KAryV32 kV = new KAryV32(int64(n));

		winLose(n, ID_AS_WIN, 1, 0, kV);

		long[] aryAsSet = Aryva.checkDup(kV.k);
	...
	public static void main(String[] sAry) throws Throwable {
		...
		for (int idx = 0, size = kV.k.length; idx != size; idx++)
			...
			O.l(B64W6.strByVCellMinus1AftRevBySAry(kV.k[idx], O.S_ARY_A_Z));
