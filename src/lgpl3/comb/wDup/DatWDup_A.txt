...
import lgpl3.o.keyNV.CompaByVInKSV32;
 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=DatWDup_A" >DatWDup_A.java</a>
 *
 * @see DatWDup
 */
public abstract class DatWDup_A implements Serializable { // 同時 for Hxy and C 或是 Hxy and P
	...
	public StringBuilder retStrToHxy = new StringBuilder(O.DEF_CAPACITY32_FOR_STR);
	...
	public void intiToHxy() {
		...
		distinctSortedSAryToHxy = new String[mapKSV32ToHxy.iLen];
		...
		for (int i = 0; i != mapKSV32ToHxy.iLen; i++) {

			kSV32 = aryOfKSV32[i];

			distinctSortedSAryToHxy[i] = kSV32.s;

			// O.l("kSV32=" + kSV32.toStr() + O.S64 + THIS);

			for (int iArrOfS = 0; iArrOfS != kSV32.int32; iArrOfS++)
				arrOfS.a(kSV32.s);

			b64W6OfQtyPlus1ToHxy = (b64W6OfQtyPlus1ToHxy << B64W6.$6) | (kSV32.int32 + 1);
