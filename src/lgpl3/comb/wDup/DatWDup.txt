 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=DatWDup" >DatWDup.java</a>
 *
 * @see Zw18
 */
public class DatWDup extends DatWDup_A {
	...
	public StringBuilder toStrAftCOrP() {
		...
		K64V32 k64V32;
		for (int i = 0, size = mapK64V32.iLen; i != size;) {
			...
			str.append(prefixForRowNum).append(i + 1).append(postfixForRowNum).append(toRowStrAftCOrP(k64V32.int64)).append(prefixForVal)
					.append(k64V32.int32).append(postfixForVal).append(lineWr);
