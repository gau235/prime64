 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=Condi" >Condi.java</a>
 *
 */
public class Condi implements Serializable {
	...
	public StringBuilder toStr() {
		...
		return new StringBuilder(O.defLenForStr).append("n,k,min,max=(" + n + "," + k + "," + min + "," + max + ")");
	}
