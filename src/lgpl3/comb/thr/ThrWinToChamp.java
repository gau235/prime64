 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=ThrWinToChamp" >src</a>
 *
 */
public class ThrWinToChamp extends ThrWBox<long[]> { // 遮蔽 最後一場 可破解
	 ...
	 * 輸 3 場: 勝敗敗敗勝勝_勝 C(6,3)
	 */
	public void winOtherwiseLose(long prefix, int countWin, int countLose) {
		...
		winOtherwiseLose(((prefix << B64W6.$6) | ID_AS_WIN), (countWin + 1), countLose); // win
		winOtherwiseLose(((prefix << B64W6.$6) | ID_AS_LOSE), countWin, (countLose + 1)); // lose
	...
	public void run() {
		...
		winOtherwiseLose(ID_AS_WIN, 1, 0); // win
		winOtherwiseLose(ID_AS_LOSE, 0, 1); // lose
