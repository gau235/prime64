 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=PeerByThrToDCirc" >PeerByThrToDCirc.java</a>
 *
 */
public class PeerByThrToDCirc extends Thread {
	...
	public void run() {
		...
		O.l("Dc(" + n + "," + k + ")=" + f32CostT + "s" + O.S9 + "thr=" + numOfThr + O.S9 + "mem=" + O.f(O.totalMem()) + O.S9
				+ "sum=" + O.f(sum));
