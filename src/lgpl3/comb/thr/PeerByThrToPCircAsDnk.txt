 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=PeerByThrToPCircAsDnk" >
 *          PeerByThrToPCircAsDnk.java</a>
 *
 */
public class PeerByThrToPCircAsDnk extends Thread {
	...
	public void run() {
		...
		O.l("numOfRemainedThr=" + seq32AftC.iLen + O.S9 + THIS);
