...
/**
 * @version 2022/05/08_10:50:00<br/>
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=Cnk_V" >Cnk_V.java</a>
 *
 * @see Cnk
 */
public abstract class Cnk_V extends Cnk_L {
	...
	public static int[] colFrom1ToN(int n) {
		...
		int my1ShiftLN = (0b1 << n);

		KAry32V32 kAry32V32 = new KAry32V32(my1ShiftLN - 1);

		for (int k = 1; k <= n; k++)

			colRecur(my1ShiftLN, k, 0b0, 0b1, kAry32V32);

		return kAry32V32.ary32;
	...
	public static int[] colByLoopBreadthFirst(int n, int k) { // 如同廣先搜尋
		...
		Seq32 seq32Moon = new Seq32(), seq32ToSwap;

		do {
			len = seq32Sun.iLen;

			do {
				curBit = B32va.highest1(keptB32 = seq32Sun.ary32[--len]);
			...
			} while (len != 0); // termination condition
