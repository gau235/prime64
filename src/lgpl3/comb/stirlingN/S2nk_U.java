 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=S2nk_U" >S2nk_U.java</a>
 *
 * @see S2nk_Y
 */
	...
	public static Arr<Seq> carteProd(Condi condi) {
		...
		for (int i = 0; i != aryOfB64W6.length; i++) {
			...
			if (condi.min == 1)
				...
				tmpArrOfSeq = CarteProdCnk.oldProdAmongHeap(condi.n, B64W6.revAmongVCell(B64W6.plusAllWV32(aryOfB64W6[i], minMinus1)));

			retArrOfSeq.appendAll(tmpArrOfSeq.arr, 0, tmpArrOfSeq.iLen);
