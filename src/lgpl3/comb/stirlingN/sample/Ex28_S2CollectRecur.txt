 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=Ex28_S2CollectRecur" >Ex28_S2CollectRecur.java</a>
 *
 */
public class Ex28_S2CollectRecur {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		O.l(S2nk.toStrByAry32_2DOfB32BySAry(retAry32_2D, O.S_ARY_A_Z, O.L));

		O.l("len=" + O.eq(retAry32_2D.iLen, S2nk.int64ByDih(condi)));
