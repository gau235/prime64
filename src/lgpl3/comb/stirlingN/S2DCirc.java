 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=S2DCirc" >S2DCirc.java</a>
 *
 * @see S2PCirc
 *
 * @see S2nk
 ...
 * @see S2DCirc
 */
public abstract class S2DCirc extends S2DCirc_A {

	// private static final Class<?> THIS = S2DCirc.class;
	...
	public static StringBuilder script(Condi condi, CharSequence lineWr) {
		...
		do {
			...
			do {
				...
				retStr.append(O.C42).append("Dc(").append(val).append(")");
