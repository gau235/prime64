 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=S2D_A" >S2D_A.java</a>
 *
 * @see S2D
 */
public abstract class S2D_A extends S2nk_Z {

	private static final Class<?> THIS = S2D_A.class;
	...
	public static long int64ByDih(Condi condi) {
		...
		do {
			...
			tmpAns = 1L;
			do {
				tmpAns *= Dnk.int64(myN, (tmp32 = (((int) b64W6ToC) & B64W6.MASK32) + diff));
