 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=S2P_Y" >S2P_Y.java</a>
 *
 * @see S2P_Z
 */
public abstract class S2P_Y extends S2P_A {
	...
	public static Arr<Seq> colToKByToGoByCartesianProd(Condi condi) {
		...
		for (int k = 1; k <= endK; k++) {
			...
			retArrOfSeq.appendAll((tmpArrOfSeq = goByCartesianProd(clonedCondi)).arr, 0, tmpArrOfSeq.iLen);
