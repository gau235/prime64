 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=ThrS2PCircWDynaB64" >ThrS2PCircWDynaB64.java</a>
 *
 */
	...
	public void run() {
		...
		if (min != 0) {
			...
			if (k == 1) {
				...
				PCirc.colRecurWNEqK(B32va.log2NPlus1(myLowest1 = (-baseB32 & baseB32)), (~myLowest1 & baseB32), retKAryV32);
