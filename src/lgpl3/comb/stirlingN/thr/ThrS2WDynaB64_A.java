 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=ThrS2WDynaB64_A" >ThrS2WDynaB64_A.java</a>
 *
 * @see ThrS2WDynaB64
 */
public abstract class ThrS2WDynaB64_A extends ThrWBox<long[]> {
	...
	public static StringBuilder rowInAbc(int b32As2Pow) { // 最多 32 字母
		...
		throw new IllegalArgumentException("b32As2Pow=" + b32As2Pow); // never reaches
