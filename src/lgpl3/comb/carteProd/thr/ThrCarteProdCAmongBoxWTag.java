...
/**
 * @version 2022/04/25_15:40:00<br/>
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=ThrCarteProdCAmongBoxWTag" >src</a>
 *
 * @see CarteProdCnk
 */
public class ThrCarteProdCAmongBoxWTag extends ThrWBox<Ary32_2D> {
	...
	public static StringBuilder toStrByAryOfB32As2Pow(int[] aryOfB32As2Pow, String[] sAry) {
		...
		for (int idx = 0; idx != aryOfB32As2Pow.length;) {
			...
			ret.append(B32va.strByLog2LowestBitBySAry(aryOfB32As2Pow[idx], sAry));

			if (++idx != aryOfB32As2Pow.length)

				ret.append(CarteProd.charSeqAsSeparator);
	...
	public static StringBuilder toStrByAry32_2D(Ary32_2D ary32_2D, String[] sAry, CharSequence charSeqAftRowNum32, CharSequence lineWr) {
		...
		for (int idx = 0; idx != ary32_2D.i;) {

			ret.append(idx + 1).append(charSeqAftRowNum32).append(toStrByAryOfB32As2Pow(ary32_2D.arr[idx++], sAry));
	...
	public static void main(String[] sAry) throws Throwable {
		...
		O.eq(thr.box.i, CarteProdCnk.mulAmongBoxWTag(B32va.countOf1(allBit), allV));
