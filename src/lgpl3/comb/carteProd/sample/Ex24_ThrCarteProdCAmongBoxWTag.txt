 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=Ex24_ThrCarteProdCAmongBoxWTag" >
...
public class Ex24_ThrCarteProdCAmongBoxWTag {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		O.eq(reAry32_2D.iLen, CarteProdCnk.mulAmongBoxWTag(B64va.countOf1(allBit), allV));
