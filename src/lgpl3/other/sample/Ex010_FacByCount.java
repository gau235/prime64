 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=Ex010_FacByCount" >Ex010_FacByCount.java</a>
 *
...
public class Ex010_FacByCount {
	...
	public static void count(AtomicInteger lv, Arr<K32V64> allDat) {
		...
		int newN = allDat.tail().int32 - 1; // n - 1
		int numOfLoop = (int) allDat.tail().int64;
		...
		if (lv.getAndAdd(1) < allDat.head().int32) // append next one
