 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=Ex983_TestCurMaxNToTest" >src</a>
 *
 */
public class Ex983_TestCurMaxNToTest {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		final int numOfThr = MySue.MY_ARY32_OF_CPU_THR[MySue.MY_ARY32_OF_CPU_THR.length >>> 1];
		...
		for (int idx = 0; idx != nOfTest; idx++) {
			...
			n1 = Miner.maxTestNByMyAryOfP - rnd.nextInt(2_000);
			n2 = Miner.maxTestNByMyAryOfP;
			...
			if (ansMP != ansCP) {
				...
				O.x("err:" + O.L + "n1=" + O.f(n1) + O.L + "n2=" + O.f(n2) + O.L + "ansMP=" + O.f(ansMP) + O.L + "ansCP="
						+ O.f(ansCP));
