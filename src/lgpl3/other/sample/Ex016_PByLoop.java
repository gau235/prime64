 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=Ex016_PByLoop" >Ex016_PByLoop.java</a>
 *
 */
public abstract class Ex016_PByLoop {
	...
	public static Seq appendTail(int baseB32, long prefix, Seq retSeq) {
		...
		int rmdB32 = B64W6.filterAftToB32As2PowByVCell(baseB32, prefix);
		int lowest1;
