 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=Ex246_WinningNum539" >Ex246_WinningNum539.java</a>
 *
 */
public class Ex246_WinningNum539 {

	public static String[] sAryWinningNumRecent3Day() throws IOException {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		StringBuilder str = Strva.mergeInStr(sAryWinningNumRecent3Day(), Jsp.L);
		O.l(str);

		// O.l(sAryWinningNumIn3Day());
