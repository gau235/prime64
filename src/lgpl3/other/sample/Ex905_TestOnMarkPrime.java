 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=Ex905_TestOnMarkPrime" >
...
public abstract class Ex905_TestOnMarkPrime {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		Marker marker = new Marker(1, Miner.$MAX_TAIL_N_FOR_GROW_ORI_ARY_OF_P / 1, B.O);
		marker.start();

		new PeerByMarker(marker).run();

		O.eq(marker.countP(1, Miner.$MAX_TAIL_N_FOR_GROW_ORI_ARY_OF_P), Miner.$MAX_LEN_OF_ORI_ARY_OF_P);
