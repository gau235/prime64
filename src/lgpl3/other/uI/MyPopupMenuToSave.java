 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=MyPopupMenuToSave" >MyPopupMenuToSave.java</a>
 *
 */
...
public class MyPopupMenuToSave extends JPopupMenu implements MouseListener {
	...
	public MyPopupMenuToSave(int int32) {
		...
		menuItemToOpenDir.setEnabled(B.O); // disable but can listen
