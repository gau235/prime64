 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=MyConfPane" >MyConfPane.java</a>
 *
 */
...
public class MyConfPane extends JScrollPane implements MouseListener {
	...
	public static final JCheckBox CHK_TO_REPEAT_MP_EP = new JCheckBox(

			Integer.toString(++idx) + ". Repeat MP and EP both 100 times");
	...
	public MyConfPane() {
		...
		CHK_TO_SEND_ERR.setSelected(O.isDev);
	...
	public void mouseReleased(MouseEvent e) {
		...
		if (objViaSource == BTN_TO_DEL_DIR) {
			...
			if (JOptionPane.showConfirmDialog(null, " Do you want the file(s) ", "Check it again",
		...
		if (objViaSource == BTN_TO_GC) {
			...
			O.l("maxP=" + O.f(Miner.maxPInMyAryOfP) + O.L + "maxN less than " + O.f(Miner.maxTestNByMyAryOfP));
