 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=MyPopupMenuWCpuQtyToDnk" >
...
public class MyPopupMenuWCpuQtyToDnk extends JPopupMenu implements MouseListener, ActionListener {
	...
	public MyPopupMenuWCpuQtyToDnk(JButton targetBtn) {
		...
		int defIdx = (O.isDev ? (MySue.MY_ARY32_OF_CPU_THR.length >>> 1) : (MySue.MY_ARY32_OF_CPU_THR.length - 1));

		JRadioButtonMenuItem rdBtnInMenu;
		for (int idx = 0; idx != MySue.MY_ARY32_OF_CPU_THR.length; idx++) {
