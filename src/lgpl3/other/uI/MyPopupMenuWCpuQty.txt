 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=MyPopupMenuWCpuQty" >MyPopupMenuWCpuQty.java</a>
 *
 */
...
public class MyPopupMenuWCpuQty extends JPopupMenu implements MouseListener, ActionListener {
	...
	public MyPopupMenuWCpuQty(int key32) {
		...
		int len = O.MY_ARY32_OF_CPU_THR.length, qty, defIdx;

		if (key32 == MySue.KEY_MP0)

			defIdx = (O.isDev ? (len >>> 1) : (len - 1)); // O.l("defIdx=" + defIdx, THIS);
		else
			defIdx = len - 1;
