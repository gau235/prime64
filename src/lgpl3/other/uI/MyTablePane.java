 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=MyTablePane" >MyTablePane.java</a>
 *
 * @see MyTableModel
 */
...
public class MyTablePane extends JScrollPane {
	...
	public static final DefaultTableModel TABLE_MODEL =
			...
			new MyTableModel(new Object[][] {}, new String[] { "N1", "N2", "Thr", "#Prime", "Cost(s)", "Time" });
	...
	public static final int N32_OF_COL = TABLE_COL_MODEL.getColumnCount(); // 6 col
