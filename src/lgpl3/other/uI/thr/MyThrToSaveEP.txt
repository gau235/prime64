 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=MyThrToSaveEP" >MyThrToSaveEP.java</a>
 *
 * @see MyThrToSaveMP
 */
public class MyThrToSaveEP extends Thread {
	...
	public void run() {
		...
		Path pathOfFile = Paths.get(MySue.sDefDirToSaveMP + File.separatorChar + MySue.MY_FILE_BASENAME + T10.timeStr().replace(3, 4, O.S95)
				+ O.S46 + MySue.MY_TXT_FILENAME_EXTENSION);
