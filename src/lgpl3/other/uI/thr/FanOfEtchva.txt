 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDocOfSrc.jsp?nameOfClass=FanOfEtchva" >FanOfEtchva.java</a>
 *
 * @see FanOfThrToMine
 *
 * @see FanOfMarker
...
public final class FanOfEtchva extends ThrWBox<Moon<ThrToEtch>> {
	...
	public void run() {
		...
		recva.note = new StringBuilder(O.DEF_CAPACITY32_FOR_STR).append("EP").append(SByN.pad0D2(box.numOfThr));
