 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=MyThrToShowCpuLoad" >MyThrToShowCpuLoad.java</a>
 *
 */
public class MyThrToShowCpuLoad extends Thread {
	...
	public void run() {
		...
		StringBuilder tailStr = new StringBuilder(O.defLenForStr).append(" / ").append(O.f(O.$XMX)).append(" MB");
