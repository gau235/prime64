 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/srchSrc.jsp?nameOfClass=MyThrToSaveMP" >MyThrToSaveMP.java</a>
 *
 * @see MyThrToSaveEP
 */
public class MyThrToSaveMP extends Thread {
	...
	public void run() {
		...
		if (MySue.moonMP.primeAry2D.i == 0) {
		...
		String sShortFileName = MySue.MY_FILE_BASENAME + T10.timeStr().replace(3, 4, O.S95) + O.S46 +

				MySue.MY_TXT_FILENAME_EXTENSION;
